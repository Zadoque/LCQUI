...
emprestimoReagenteCampos: [
	...
	#CampoEmprestimo & {nome: "peso_perda_evaporacao", sql: "NUMERIC(10,3)", observacao: "Perda em g registrada separadamente do consumo; não inferir arbitrariamente."},
	...
	#CampoEmprestimo & {nome: "massa_perda_estimada_g", sql: "NUMERIC(10,3)", nulo: true},
]
