...
frascoCompletoCampos: [
	...
	#CampoFrasco & {nome: "conteudo_nominal", sql: "NUMERIC(10,3)", nulo: true, nao_negativo: true, observacao: "null representa desconhecido; zero é um valor numérico distinto e não negativo."},
	#CampoFrasco & {nome: "peso_no_cadastrado", sql: "NUMERIC(10,3)", nao_negativo: true},
	#CampoFrasco & {nome: "peso_atual", sql: "NUMERIC(10,3)", nao_negativo: true},
	#CampoFrasco & {nome: "peso_frasco_vazio", sql: "NUMERIC(10,3)", nulo: true, nao_negativo: true},
	...
	#CampoFrasco & {nome: "medida_usada", sql: "NUMERIC(10,3)", nao_negativo: true},
