...
const EXPECTED: &[(&str, &str, &str, &str, &str)] = &[
    ...
    (
        "COMP-M2-EXTRAVIO-AUTORIZACAO-001",
    ...
    (
        "COMP-M2-REENCONTRO-COERENCIA-001",
        "ReencontroCoerente",
        "check",
    ...
    (
        "COMP-M2-REENCONTRO-QUEBRADO-IND-001",
        "QuebradoReencontradoNaoDisponivel",
        "check",
    ...
    (
        "COMP-M2-EXTRAVIO-QUEBRADO-001",
        "ExtravioQuebradoHabitavel",
        "run",
        "run ExtravioQuebradoHabitavel for 4 but exactly 2 EstadoIntegrado",
        "SAT",
    ),
    (
        "COMP-M2-REENCONTRO-QUEBRADO-001",
        "ReencontroQuebradoHabitavel",
        "run",
