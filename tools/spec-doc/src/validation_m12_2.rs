...
const EXPECTED: &[(&str, &str, &str, &str, &str)] = &[
    ...
    (
        "M12_2-INV-016",
        "CompartilhamentoSoDePublicavel",
        "check",
        "UNSAT",
    ...
    (
        "M12_2-INV-027",
        "EncerrarEscopoImpedeNovaEmissao",
        "check",
        "UNSAT",
    ...
    (
        "M12_2-INV-028",
        "UrlEmitidaSobreviveAoEncerramentoEscopo",
        "check",
        "UNSAT",
    ...
    (
        "M12_2-INV-040",
        "EscopoQ13SoDeChefeComPostReferenciado",
        "check",
        "UNSAT",
    ...
    (
        "M12_2-INV-050",
        "ChefeComVinculoLegadoNaoUsaRotaAcademica",
        "check",
        "UNSAT",
    ...
    (
        "M12_2-INV-051",
        "PromoverChefePreservaVinculoLegado",
        "check",
        "UNSAT",
    ...
    (
        "M12_2-INV-052",
        "PromoverChefePreservaCoerencia",
        "check",
        "UNSAT",
    ...
    (
        "M12_2-WIT-064",
        "WitnessProvisorioNaoCompartilha",
        "run",
        "SAT",
    ...
    (
        "M12_2-WIT-069",
        "WitnessEncerrarEscopoImpedeEmissao",
        "run",
        "SAT",
    ...
    (
        "M12_2-WIT-078",
        "WitnessChefeComVinculoLegadoNaoUsaRotaAcademica",
        "run",
        "SAT",
    ...
    (
        "M12_2-WIT-079",
        "WitnessPromocaoChefeMantemVinculo",
        "run",
        "SAT",
...
/// Escopo Q13 ativo: existe intervenção registrada do Chefe sobre um Post que
/// referencia o roteiro. Sem par (chefe, roteiro) correspondente, a nova emissão
/// pelo Chefe é negada; a URL já emitida permanece até expirar.
#[cfg(test)]
pub fn escopo_q13_ativo(id_chefe: &str, id_roteiro: &str, escopos: &[(&str, &str)]) -> bool {
    !id_chefe.is_empty()
        && !id_roteiro.is_empty()
        && escopos
            .iter()
            .any(|(c, r)| *c == id_chefe && *r == id_roteiro)
}
...
mod tests {
    ...
    fn limites_e_vinculos_respeitam_o_contrato() {
        ...
        assert!(escopo_q13_ativo(
            "chefe-1",
            "rot-1",
            &[("chefe-1", "rot-1"), ("chefe-2", "rot-9")]
        ));
        assert!(!escopo_q13_ativo(
            "chefe-1",
            "rot-1",
        ...
        assert!(!escopo_q13_ativo("chefe-1", "rot-1", &[]));
        assert!(!escopo_q13_ativo("", "rot-1", &[("", "rot-1")]));
    }
}
