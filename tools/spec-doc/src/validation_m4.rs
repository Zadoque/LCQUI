...
const EXPECTED: &[(&str, &str, &str, &str, &str)] = &[
    ...
    (
        "INV-M4-RETIRADA-VENCIMENTO-001",
        "RetiradaVencimentoApto",
        "check",
        "check RetiradaVencimentoApto for 4 but exactly 2 Estado",
        "UNSAT",
    ),
    (
        "INV-M4-RETIRADA-SNAPSHOT-001",
        "RetiradaSnapshotVencido",
        "check",
    ...
    (
        "INV-M4-ANOMALIA-DESTINO-001",
        "AnomaliaPrecedeDestino",
        "check",
    ...
    (
        "INV-M4-DEVOLUCAO-NAO-RECALCULA-001",
        "DevolucaoNaoRecalculaVencimento",
        "check",
        "check DevolucaoNaoRecalculaVencimento for 4 but exactly 2 Estado",
        "UNSAT",
    ),
    (
        "INV-M4-DEVOLUCAO-SNAPSHOT-001",
        "DevolucaoSnapshotImutavel",
        "check",
        "check DevolucaoSnapshotImutavel for 4 but exactly 2 Estado",
        "UNSAT",
    ),
    (
        "INV-M4-CLASSIFICACAO-VENCEU-001",
        "ClassificacaoVenceuDurante",
        "check",
        "check ClassificacaoVenceuDurante for 4 but exactly 2 Estado",
        "UNSAT",
    ),
    (
        "INV-M4-CLASSIFICACAO-JA-VENCIDO-001",
        "ClassificacaoJaVencido",
        "check",
        "check ClassificacaoJaVencido for 4 but exactly 2 Estado",
        "UNSAT",
    ),
    (
        "INV-M4-CLASSIFICACAO-DESCONHECIDA-001",
        "ClassificacaoValidadeDesconhecida",
        "check",
        "check ClassificacaoValidadeDesconhecida for 4 but exactly 2 Estado",
        "UNSAT",
    ),
    (
        "INV-M4-CLASSIFICACAO-NORMAL-001",
        "ClassificacaoNormal",
        "check",
    ...
    (
        "INV-M4-CLASSIFICACAO-PRECEDENCIA-VENCIDO-001",
        "ClassificacaoVencidoPrecedeDesconhecida",
        "check",
        "check ClassificacaoVencidoPrecedeDesconhecida for 4 but exactly 2 Estado",
        "UNSAT",
    ),
    (
        "INV-M4-CLASSIFICACAO-PRECEDENCIA-JAVENCIDO-001",
        "ClassificacaoJaVencidoPrecedeDesconhecida",
        "check",
    ...
    (
        "WIT-M4-RETIRADA-VENCIDA-ABERTURA-001",
        "RetiradaVencidaNaAbertura",
        "run",
    ...
    (
        "WIT-M4-VENCEU-DURANTE-001",
        "VenceuDuranteEmprestimo",
        "run",
        "run VenceuDuranteEmprestimo for 4 but exactly 2 Estado",
        "SAT",
    ),
    (
        "WIT-M4-JA-VENCIDO-001",
        "JaEstavaVencidoNoRetorno",
        "run",
        "run JaEstavaVencidoNoRetorno for 4 but exactly 2 Estado",
        "SAT",
    ),
    (
        "WIT-M4-VALIDADE-DESCONHECIDA-001",
        "ValidadeDesconhecidaNoRetorno",
        "run",
    ...
    (
        "INV-M4-DEVOLUCAO-SNAPSHOT-006",
        "DevolucaoSnapshotImutavelAmpliado",
        "check",
