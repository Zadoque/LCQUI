...
pub const M2_MODELOS: [(&str, &[M2Resultado]); 2] = [
    ...
    (
        ...
        &[
            ...
            (
                "FRAME-M2-EXTRAVIO-FISICO-001",
                "ExtravioPreservaFisico",
                "check",
                "UNSAT",
                "check ExtravioPreservaFisico for 4 but exactly 2 Estado",
            ),
            (
                "FRAME-M2-EXTRAVIO-LOCALIZACAO-001",
                "ExtravioMarcaLocalizacao",
                "check",
                "UNSAT",
                "check ExtravioMarcaLocalizacao for 4 but exactly 2 Estado",
            ),
            (
                "FRAME-M2-EXTRAVIO-AUTORIZACAO-001",
                "ExtravioRevogaAutorizacao",
                "check",
                "UNSAT",
            ...
            (
                "FRAME-M2-REENCONTRO-LOCALIZACAO-001",
                "ReencontroLocalizaEQuarentena",
                "check",
                "UNSAT",
                "check ReencontroLocalizaEQuarentena for 4 but exactly 2 Estado",
            ),
            (
                "FRAME-M2-REENCONTRO-FISICO-001",
                "ReencontroPreservaFisico",
                "check",
                "UNSAT",
                "check ReencontroPreservaFisico for 4 but exactly 2 Estado",
            ),
            (
                "FRAME-M2-REENCONTRO-AUTORIZACAO-001",
            ...
            (
                "INV-M2-REENCONTRO-QUEBRADO-IND-001",
                "QuebradoNaoDisponivelAposReencontro",
                "check",
                "UNSAT",
            ...
            (
                "WIT-M2-EXTRAVIO-FISICO-001",
                "TestemunhaExtravioPreservaFisico",
                "run",
                "SAT",
                "run TestemunhaExtravioPreservaFisico for 4 but exactly 2 Estado",
            ),
            (
                "WIT-M2-REENCONTRO-QUEBRADO-001",
                "TestemunhaReencontroQuebrado",
                "run",
                "SAT",
