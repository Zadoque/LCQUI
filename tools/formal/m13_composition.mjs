...
export const m13Expected = [
	...
	{id:"M13-INV-031", name:"FanOutNaoDuplicaDestinatario", type:"check", scope:"check FanOutNaoDuplicaDestinatario for 4", overall:4},
	{id:"M13-INV-032", name:"ErroEmissaoNaoViraSucesso", type:"check", scope:"check ErroEmissaoNaoViraSucesso for 4", overall:4},
	{id:"M13-INV-033", name:"ComposicaoM7RetryNaoDuplica", type:"check", scope:"check ComposicaoM7RetryNaoDuplica for 4", overall:4},
	{id:"M13-INV-034", name:"IdTurmaAcademicoObrigatorio", type:"check", scope:"check IdTurmaAcademicoObrigatorio for 4", overall:4},
	{id:"M13-INV-035", name:"IdTurmaOperacionalNulo", type:"check", scope:"check IdTurmaOperacionalNulo for 4", overall:4},
	...
	{id:"M13-WIT-056", name:"WitnessFanOutMesmaOperacao", type:"run", scope:"run WitnessFanOutMesmaOperacao for 4", overall:4},
	{id:"M13-WIT-057", name:"WitnessErroNaoEmite", type:"run", scope:"run WitnessErroNaoEmite for 4", overall:4},
	{id:"M13-WIT-058", name:"WitnessColegaVeAviso", type:"run", scope:"run WitnessColegaVeAviso for 4", overall:4},
	{id:"M13-WIT-059", name:"WitnessAutorVeOriginal", type:"run", scope:"run WitnessAutorVeOriginal for 4", overall:4},
	{id:"M13-WIT-060", name:"WitnessAuditorVeOriginal", type:"run", scope:"run WitnessAuditorVeOriginal for 4", overall:4},
];
