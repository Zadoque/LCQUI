...
function alloyCheck() {
  ...
  runMilestone('specification/alloy/operations/posts_m12_1.als', [
    ["CriarPostSoEmAtivo","check","check CriarPostSoEmAtivo for 6"],
    ["EditarPostSoEmAtivo","check","check EditarPostSoEmAtivo for 6"],
    ["RemoverPostSoEmAtivo","check","check RemoverPostSoEmAtivo for 6"],
    ["CriarComentSoEmAtivo","check","check CriarComentSoEmAtivo for 6"],
    ["EditarComentSoEmAtivo","check","check EditarComentSoEmAtivo for 6"],
    ["ModerarComentSoEmAtivo","check","check ModerarComentSoEmAtivo for 6"],
    ["TurmaArquivadaNegaEscrita","check","check TurmaArquivadaNegaEscrita for 6"],
    ["ChefeNaoCriaPost","check","check ChefeNaoCriaPost for 6"],
    ["ChefeNaoEditaConteudo","check","check ChefeNaoEditaConteudo for 6"],
    ["AutorImutavelPost","check","check AutorImutavelPost for 6"],
    ["AutorImutavelComent","check","check AutorImutavelComent for 6"],
    ["TerceiroNaoEditaPost","check","check TerceiroNaoEditaPost for 6"],
    ["TerceiroNaoEditaComent","check","check TerceiroNaoEditaComent for 6"],
    ["ComentarExigeParticipacaoAtual","check","check ComentarExigeParticipacaoAtual for 6"],
    ["EditarComentExigeParticipacaoAtual","check","check EditarComentExigeParticipacaoAtual for 6"],
    ["RemovidoNaoEditaComent","check","check RemovidoNaoEditaComent for 6"],
    ["RemovidoNaoLe","check","check RemovidoNaoLe for 6"],
    ["LerExigeParticipacaoOuPapel","check","check LerExigeParticipacaoOuPapel for 6"],
    ["InativoNaoLe","check","check InativoNaoLe for 6"],
    ["EdicaoPostCriaHistorico","check","check EdicaoPostCriaHistorico for 6"],
    ["RemocaoPostCriaHistorico","check","check RemocaoPostCriaHistorico for 6"],
    ["RemocaoPreservaDocumento","check","check RemocaoPreservaDocumento for 6"],
    ["HistoricoNuncaRemovido","check","check HistoricoNuncaRemovido for 6"],
    ["EdicaoComentCriaHistorico","check","check EdicaoComentCriaHistorico for 6"],
    ["ModeracaoComentCriaHistorico","check","check ModeracaoComentCriaHistorico for 6"],
    ["EdicaoNaoDesfazModeracao","check","check EdicaoNaoDesfazModeracao for 6"],
    ["ComentModeradoPreservado","check","check ComentModeradoPreservado for 6"],
    ["ColegaNaoVeOriginalModerado","check","check ColegaNaoVeOriginalModerado for 6"],
    ["AutorVeOriginalMarcado","check","check AutorVeOriginalMarcado for 6"],
    ["AuditorVeOriginal","check","check AuditorVeOriginal for 6"],
    ["NotificacaoSoDoAlvo","check","check NotificacaoSoDoAlvo for 6"],
    ["SemAcessoNaoPublicaComRoteiro","check","check SemAcessoNaoPublicaComRoteiro for 6"],
    ["PublicacaoComRoteiroExigeAcesso","check","check PublicacaoComRoteiroExigeAcesso for 6"],
    ["PrimeiraExecucaoProduzReceipt","check","check PrimeiraExecucaoProduzReceipt for 6"],
    ["IdentidadeComandoUnica","check","check IdentidadeComandoUnica for 6"],
    ["ReusoIncompativelRejeitado","check","check ReusoIncompativelRejeitado for 6"],
    ["RetryNaoReexecuta","check","check RetryNaoReexecuta for 6"],
    ["RetryNaoDuplicaFato","check","check RetryNaoDuplicaFato for 6"],
    ["RevogacaoImpedeCommit","check","check RevogacaoImpedeCommit for 6"],
    ["TransicoesPreservamCoerencia","check","check TransicoesPreservamCoerencia for 6"],
    ["WitnessTurmaAtiva","run","run WitnessTurmaAtiva for 4"],
    ["WitnessCriarPost","run","run WitnessCriarPost for 6"],
    ["WitnessPublicaComRoteiro","run","run WitnessPublicaComRoteiro for 6"],
    ["WitnessEditarPost","run","run WitnessEditarPost for 6"],
    ["WitnessRemoverPost","run","run WitnessRemoverPost for 6"],
    ["WitnessCriarComent","run","run WitnessCriarComent for 6"],
    ["WitnessEditarComent","run","run WitnessEditarComent for 6"],
    ["WitnessModerarComent","run","run WitnessModerarComent for 6"],
    ["WitnessEdicaoNaoDesfazModeracao","run","run WitnessEdicaoNaoDesfazModeracao for 6"],
    ["WitnessLeituraMascarada","run","run WitnessLeituraMascarada for 6"],
    ["WitnessChefeModera","run","run WitnessChefeModera for 6"],
    ["WitnessRemocaoAlunoBloqueia","run","run WitnessRemocaoAlunoBloqueia for 6"],
    ["WitnessRetryAposExecucao","run","run WitnessRetryAposExecucao for 6"],
    ["WitnessClaimAtualSemVinculo","run","run WitnessClaimAtualSemVinculo for 6"],
    ["WitnessReusoIncompativel","run","run WitnessReusoIncompativel for 6"],
    ["WitnessRoteiroAceito","run","run WitnessRoteiroAceito for 6"],
    ["WitnessRetry","run","run WitnessRetry for 4"],
  ], 'build/formal-validation-m12-1.json', 'M12_1');
  runMilestone('specification/alloy/operations/roteiros_m12_2.als', [
    ['CadastroComecaProvisorio','check','check CadastroComecaProvisorio for 6'],
    ['PublicavelSoDeValidado','check','check PublicavelSoDeValidado for 6'],
    ['ValidarFixaGeracao','check','check ValidarFixaGeracao for 6'],
    ['RoteiroValidadoTemGeracao','check','check RoteiroValidadoTemGeracao for 6'],
    ['DonoImutavel','check','check DonoImutavel for 6'],
    ['ObjetoNuncaSobrescrito','check','check ObjetoNuncaSobrescrito for 6'],
    ['GeracaoNaoMudaSemValidar','check','check GeracaoNaoMudaSemValidar for 6'],
    ['SemObjetoNaoEmite','check','check SemObjetoNaoEmite for 6'],
    ['AnexoUsaGeracaoCanonica','check','check AnexoUsaGeracaoCanonica for 6'],
    ['AnexoUnicoPorPost','check','check AnexoUnicoPorPost for 6'],
    ['CompartilharSoProprietario','check','check CompartilharSoProprietario for 6'],
    ['CompartilharExigeDestinatarioAtivo','check','check CompartilharExigeDestinatarioAtivo for 6'],
    ['CompartilhamentoUnico','check','check CompartilhamentoUnico for 6'],
    ['RevogarSoProprietario','check','check RevogarSoProprietario for 6'],
    ['NaoProprietarioNaoRevoga','check','check NaoProprietarioNaoRevoga for 6'],
    ['CompartilhamentoSoDePublicavel','check','check CompartilhamentoSoDePublicavel for 6'],
    ['NaoCompartilhaNaoPublicavel','check','check NaoCompartilhaNaoPublicavel for 6'],
    ['EmissaoExigeAcesso','check','check EmissaoExigeAcesso for 6'],
    ['ExAlunoNaoEmite','check','check ExAlunoNaoEmite for 6'],
    ['InativoNaoEmite','check','check InativoNaoEmite for 6'],
    ['AlunoDependeDeVinculo','check','check AlunoDependeDeVinculo for 6'],
    ['PostRemovidoNegaAluno','check','check PostRemovidoNegaAluno for 6'],
    ['TurmaArquivadaNegaEscritaRoteiro','check','check TurmaArquivadaNegaEscritaRoteiro for 6'],
    ['UrlEmitidaSobreviveARevogacao','check','check UrlEmitidaSobreviveARevogacao for 6'],
    ['UrlExpiradaNaoUsavel','check','check UrlExpiradaNaoUsavel for 6'],
    ['UrlAtivaUsavel','check','check UrlAtivaUsavel for 6'],
    ['EncerrarEscopoImpedeNovaEmissao','check','check EncerrarEscopoImpedeNovaEmissao for 6'],
    ['UrlEmitidaSobreviveAoEncerramentoEscopo','check','check UrlEmitidaSobreviveAoEncerramentoEscopo for 6'],
    ['AnexarSoDonoDaTurma','check','check AnexarSoDonoDaTurma for 6'],
    ['AnexarExigeAcessoAtual','check','check AnexarExigeAcessoAtual for 6'],
    ['ManterExigeAcessoAtual','check','check ManterExigeAcessoAtual for 6'],
    ['TrocarExigeAcessoAtual','check','check TrocarExigeAcessoAtual for 6'],
    ['RemocaoPostPreservaSnapshot','check','check RemocaoPostPreservaSnapshot for 6'],
    ['HistoricoAnexoNuncaRemovido','check','check HistoricoAnexoNuncaRemovido for 6'],
    ['HistoricoAnexoPreservaObjeto','check','check HistoricoAnexoPreservaObjeto for 6'],
    ['AnexoEhGeracaoValidada','check','check AnexoEhGeracaoValidada for 6'],
    ['ChefeNaoAnexa','check','check ChefeNaoAnexa for 6'],
    ['ChefeNaoCompartilha','check','check ChefeNaoCompartilha for 6'],
    ['ChefeSemEscopoNaoEmite','check','check ChefeSemEscopoNaoEmite for 6'],
    ['EscopoQ13SoDeChefeComPostReferenciado','check','check EscopoQ13SoDeChefeComPostReferenciado for 6'],
    ['RevogacaoVinculoImpedeCommit','check','check RevogacaoVinculoImpedeCommit for 6'],
    ['PrimeiraExecucaoProduzReceipt','check','check PrimeiraExecucaoProduzReceipt for 6'],
    ['IdentidadeComandoUnica','check','check IdentidadeComandoUnica for 6'],
    ['ReusoIncompativelRejeitado','check','check ReusoIncompativelRejeitado for 6'],
    ['RetryNaoReexecuta','check','check RetryNaoReexecuta for 6'],
    ...
    ['WitnessPublica','run','run WitnessPublica for 6'],
    ['WitnessProprietarioEmite','run','run WitnessProprietarioEmite for 6'],
    ['WitnessCompartilhadoEmite','run','run WitnessCompartilhadoEmite for 6'],
    ['WitnessAlunoEmitePostAtivo','run','run WitnessAlunoEmitePostAtivo for 6'],
    ['WitnessAlunoEmiteTurmaArquivada','run','run WitnessAlunoEmiteTurmaArquivada for 6'],
    ['WitnessExAlunoNaoEmite','run','run WitnessExAlunoNaoEmite for 6'],
    ['WitnessRevogadoNaoEmite','run','run WitnessRevogadoNaoEmite for 6'],
    ['WitnessUrlAtivaAposRevogacao','run','run WitnessUrlAtivaAposRevogacao for 6'],
    ['WitnessProvisorioNaoCompartilha','run','run WitnessProvisorioNaoCompartilha for 6'],
    ['WitnessValidadoNaoCompartilha','run','run WitnessValidadoNaoCompartilha for 6'],
    ['WitnessCompartilhaPublicavel','run','run WitnessCompartilhaPublicavel for 6'],
    ['WitnessChefeComEscopoQ13','run','run WitnessChefeComEscopoQ13 for 6'],
    ['WitnessChefeSemEscopoNaoEmite','run','run WitnessChefeSemEscopoNaoEmite for 6'],
    ['WitnessEncerrarEscopoImpedeEmissao','run','run WitnessEncerrarEscopoImpedeEmissao for 6'],
    ['WitnessPostRemovidoNaoEmiteAluno','run','run WitnessPostRemovidoNaoEmiteAluno for 6'],
    ['WitnessAnexaComAcesso','run','run WitnessAnexaComAcesso for 6'],
    ['WitnessMantemComAcesso','run','run WitnessMantemComAcesso for 6'],
    ['WitnessDesvinculaSemAcesso','run','run WitnessDesvinculaSemAcesso for 6'],
    ['WitnessTrocaPreservaHistorico','run','run WitnessTrocaPreservaHistorico for 6'],
    ['WitnessRetryAposExecucao','run','run WitnessRetryAposExecucao for 6'],
    ['WitnessReusoIncompativel','run','run WitnessReusoIncompativel for 6'],
