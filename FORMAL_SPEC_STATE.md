...
| M12.1 | Posts, comentários, edição/moderação e históricos | DOCUMENTATION_VALIDATED |
...
## 9. Milestone atual
M4 VALIDATED (Retirada/devolução completas, com erratum pré-M5). M3 VALIDATED (com erratum pré-M5); M5 = VALIDATED; M6 = VALIDATED; M7 = VALIDATED; M8 = VALIDATED; M9 = VALIDATED; M10 = VALIDATED; M11 = VALIDATED; M12.1 = DOCUMENTATION_VALIDATED. A implementação Firebase continua fora da evidência formal.
...
M10 permanece encerrado. A entrada em M11 — Turmas / demais domínios — foi avaliada e concluída em rodadas separadas (documental e executável): **M11 = VALIDATED**. M12.1 documental foi concluído (**M12.1 = DOCUMENTATION_VALIDATED**, Seção 7.6; worklog `documentation/worklogs/formal-spec/M12_1_DOCUMENTATION.md`). Próxima ação: formalização executável M12.1; depois M12.2 (Roteiros/Storage) e o fechamento M12. Registro executável de M10 em `documentation/worklogs/formal-spec/M10_EXECUTABLE_VALIDATION.md`; de M11 em `documentation/worklogs/formal-spec/M11_EXECUTABLE_VALIDATION.md`.
