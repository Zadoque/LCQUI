...
| M13 | Notificação unificada (leitura multi-role, lida/Limpar tudo, expiração, alvo, privacidade, dedup V1) | DOCUMENTATION_VALIDATED (executável pendente) |

## 9. Milestone atual
M4 VALIDATED (Retirada/devolução completas, com erratum pré-M5). M3 VALIDATED (com erratum pré-M5); M5 = VALIDATED; M6 = VALIDATED; M7 = VALIDATED; M8 = VALIDATED; M9 = VALIDATED; M10 = VALIDATED; M11 = VALIDATED; M12.1 = VALIDATED; M12.2 = VALIDATED; M12 = VALIDATED (composição M12.1/M12.2); M13 = DOCUMENTATION_VALIDATED (Seção 7.8; executável pendente). A implementação Firebase continua fora da evidência formal.
