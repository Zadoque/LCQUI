...
\begin{itemize}
	...
	\item \textbf{Compartilhar/revogar}: ator proprietário; pré: destinatário
	professor ativo, relação única; efeito: ACL atualizada (idempotente) +
	notificação mínima; falha: nenhuma ACL parcial.
	...
	aluno com vínculo atual e Post acessível; Chefe por Q13; efeito: URL curta
