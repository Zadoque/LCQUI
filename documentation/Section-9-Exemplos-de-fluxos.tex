...
\textbf{Contrato:} UI-07. Alertas > categoria > frasco > ação/motivo > confirmar. Validar transição e empréstimo ativo; gravar evento, manter identidade e invalidar saldo/alerta. Descarte é terminal; política de remoção lógica em Q07. Em caso de extravio, o frasco assume estado EXTRAVIADO e um eventual empréstimo ativo sofre encerramento extraordinário. Em caso de reencontro, o frasco retorna como ABERTO ou FECHADO (conforme constatado), porém obrigatoriamente com \textit{em\_quarentena = true}; o empréstimo encerrado não é reaberto.
