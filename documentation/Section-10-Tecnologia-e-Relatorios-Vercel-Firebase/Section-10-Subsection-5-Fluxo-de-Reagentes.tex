...
export const cadastrarFrascoFechado = onCall(async (request) => {
  ...
  const validadeData = validadeFechadoStr ? new Date(validadeFechadoStr) : null;
  ...
  return admin.firestore().runTransaction(async (tx) => {
    ...
    if (dados.idLote) {
      ...
      const countAtual = loteMatSnap.exists ? (loteMatSnap.data()!.count || 0) : 0;
...
export const cadastrarFrascoAberto = onCall(async (request) => {
  ...
  const validadeData = validadeAbertoStr ? new Date(validadeAbertoStr) : null;
