...
Moderar posts/comentários & \checkmark\ (Q13) & -- & -- & \checkmark\ (dono) & -- & --\\
Gerenciar roteiros próprios & \checkmark & -- & -- & \checkmark & -- & --\\
Compartilhar roteiros & \checkmark & -- & -- & \checkmark & -- & --\\
Baixar roteiro (dono, compartilhado ou Post acessível) & \checkmark\ (Q13) & -- & -- & \checkmark & \checkmark & \checkmark\\
Receber notificações próprias (caixa única por conta) & \checkmark & \checkmark & \checkmark & \checkmark & \checkmark & \checkmark\\
...
A caixa de notificações é única por conta (UID) e reúne todos os papéis de que a pessoa participa, inclusive Bolsista e Chefe; o papel visual selecionado no header não filtra a caixa nem concede privilégio. O contrato da entidade única \textit{Notificacao}, da marcação de leitura, de ``Limpar tudo'', da expiração e do alvo é a Seção~\ref{sec:regras-notificacoes-m13}.
\end{explicacao}
