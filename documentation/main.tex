...
% -------------------------------------------------
\input{Section-1-Introducao.tex}
\input{Section-2-Como-vai-ser-o-Sistema.tex}
\input{Section-3-Stakeholders.tex}
\input{Section-4-Modelagem-Entidades-SQL-3FN.tex}
\input{Section-5-Notas-de-Mapeamento-para-Firestore.tex}
\input{Section-6-Materialized-Views.tex}
\input{Section-7-Requisitos-e-Regras-de-Negocio.tex}
\input{Section-8-Descricao-das-telas-Dashboards.tex}
\input{Section-9-Exemplos-de-fluxos.tex}
\input{Section-10-Tecnologia-e-Relatorios-Vercel-Firebase/Section-10-Tecnologia-e-Relatorios-Vercel-Firebase_main.tex}
\input{Section-11-Regras-de-Seguranca-do-Firestore-Security-Rules.tex}
\input{Section-12-Implementacoes-em-Estudo-para-Versoes-Futuras.tex}

\input{Formal-Spec-M0.tex}
\input{Formal-Spec-M1.tex}
\input{Formal-Spec-M2.tex}
\input{Formal-Spec-M3.tex}
\input{Formal-Spec-M4.tex}
\input{Formal-Spec-M5.tex}
\input{Formal-Spec-M6.tex}
\input{Formal-Spec-M7.tex}
\input{Formal-Spec-M8.tex}
\input{Formal-Spec-M9.tex}
\input{Formal-Spec-M10.tex}
\input{Formal-Spec-M11.tex}
\input{Formal-Spec-M12-1.tex}
\input{Formal-Spec-M12-2.tex}
\input{Formal-Spec-M12.tex}
\input{Formal-Spec-M13.tex}
