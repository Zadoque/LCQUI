...
de turma não autoriza exceção. Removido anteriormente não reingressa por
código, apenas por convite explícito, e a remoção decrementa o contador uma
única vez, nunca abaixo de zero. O contrato completo de ingresso, remoção,
reingresso e arquivamento está na Seção~\ref{sec:regras-turmas-m11}.
\end{regra}
