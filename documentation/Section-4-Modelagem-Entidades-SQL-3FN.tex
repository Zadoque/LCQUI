...
EXTRAVIADO & Não pode estar EMPRESTADO: empréstimo ativo é encerrado extraordinariamente; \texttt{disponibilidade = INDISPONIVEL}. Preserva saldo, \texttt{saldo\_desconhecido}, \texttt{peso\_atual}, tara, \texttt{vencido}, \texttt{abertura\_historica\_desconhecida} e localização. Extravio não é consumo, esgotamento nem peso zero. Estado físico anterior recuperável pela trilha histórica.\\
