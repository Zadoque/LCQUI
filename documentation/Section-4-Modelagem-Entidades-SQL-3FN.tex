...
\end{regra}
\begin{explicacao}
\textit{id\_resumo\_reagente} é obrigatoriamente denormalizado no nível do Lote para permitir consultas e cálculos diretos (agregando estoques por Resumo) sem necessitar resolver o caminho físico pela Especificação (caracterizando um desvio deliberado da 3FN focado em leitura/performance).
