...
\item[M13-INV-031] FanOutNaoDuplicaDestinatario: UNSAT.\newline Escopo: \texttt{check FanOutNaoDuplicaDestinatario for 4}.
\item[M13-INV-032] ErroEmissaoNaoViraSucesso: UNSAT.\newline Escopo: \texttt{check ErroEmissaoNaoViraSucesso for 4}.
\item[M13-INV-033] ComposicaoM7RetryNaoDuplica: UNSAT.\newline Escopo: \texttt{check ComposicaoM7RetryNaoDuplica for 4}.
\item[M13-INV-034] IdTurmaAcademicoObrigatorio: UNSAT.\newline Escopo: \texttt{check IdTurmaAcademicoObrigatorio for 4}.
\item[M13-INV-035] IdTurmaOperacionalNulo: UNSAT.\newline Escopo: \texttt{check IdTurmaOperacionalNulo for 4}.
...
\item[M13-WIT-056] WitnessFanOutMesmaOperacao: SAT.\newline Escopo: \texttt{run WitnessFanOutMesmaOperacao for 4}.
\item[M13-WIT-057] WitnessErroNaoEmite: SAT.\newline Escopo: \texttt{run WitnessErroNaoEmite for 4}.
\item[M13-WIT-058] WitnessColegaVeAviso: SAT.\newline Escopo: \texttt{run WitnessColegaVeAviso for 4}.
\item[M13-WIT-059] WitnessAutorVeOriginal: SAT.\newline Escopo: \texttt{run WitnessAutorVeOriginal for 4}.
\item[M13-WIT-060] WitnessAuditorVeOriginal: SAT.\newline Escopo: \texttt{run WitnessAuditorVeOriginal for 4}.
\end{description}
