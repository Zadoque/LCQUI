...
\subsection*{Emprestimo\_Reagente --- projeção M3 completa (33 colunas)}
Registro relacional completo do empréstimo (33 colunas). Não é payload de criação nem documento Firestore completo. A existência global das FKs, a unicidade de empréstimo ativo por frasco e as transições de status são verificadas fora do registro (loan\_state.als).
\begin{description}
...
Máximo: 9999999.999.
Múltiplo de 0.001.
Consumo validado não negativo na unidade do empréstimo; null até a validação quantitativa.
