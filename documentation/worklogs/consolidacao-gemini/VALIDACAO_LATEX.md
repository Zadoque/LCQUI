...
| 2026-09-14T14:05 | Lote 2.2 Complemento V4 | ab804eec | `... latexmk -cd -pdf -interaction=nonstopmode -halt-on-error -outdir=/tmp/lcqui-tex-lote2-2-complemento-v4 documentation/main.tex > ...` | **0** | **199** | **0** | **0** | — | — | limpo | Sim (PDF-001, PDF-016) | Corrigido status de retorno e validação antecipada de resumo. Refinado contrato temporal ancorando criação ao commitTime e exclusão ao event.time. Main.pdf atualizado. |
