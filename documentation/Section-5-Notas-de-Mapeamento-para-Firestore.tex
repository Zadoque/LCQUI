...
\item[\texttt{tipo}] string enum; O. Valor de tipo, validado pelo formulário e pelo servidor conforme regras do domínio. Valores: CADASTRO, SAIU, ENTROU, AJUSTE, FICOU\_VAZIO, EXTRAVIO, REENCONTRO, EVAPORACAO, FOI\_DESCARTADO.
