...
\item[\texttt{volume\_evaporado\_no\_dia\_ml}] number; O. Perda total por evaporação de líquidos no dia em mL, acumulada a partir dos campos \texttt{peso\_perda\_evaporacao} das devoluções com \texttt{unidade\_medida\_utilizada = ml}; não negativa.
