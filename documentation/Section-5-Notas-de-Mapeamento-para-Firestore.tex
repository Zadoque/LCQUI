...
\item[\texttt{em\_quarentena}] boolean; O. Bloqueio operacional independente de abertura e vencimento; true exige motivo associado e detalhe\_status não nulo. Na entrada manual com justificativa humana obrigatória, exigir pelo menos 20 caracteres após trim.
...
\item[\texttt{saldo\_desconhecido}] boolean; O, padrão false. True marca frasco aberto cujo saldo atual não é quantificado; não somar em \texttt{volume\_total\_disponivel\_aferido\_ml} nem em \texttt{massa\_total\_disponivel\_aferida\_g}, contabilizando-o apenas em \texttt{qtd\_frascos\_saldo\_desconhecido}.
\end{description}
