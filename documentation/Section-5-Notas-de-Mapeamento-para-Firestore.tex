...
o catálogo JSON materializado (Seção~10.5): o catálogo inteiro é carregado no
...
Resumo\_Reagente & Coleção raiz. Denorm: \texttt{letra\_inicial} (legado) & Catálogo de reagentes; a busca vigente é em memória sobre o catálogo JSON (Seção~10.5) e não exige \texttt{letra\_inicial}. Campo mantido como legado; depreciação proposta em rodada formal própria.\\
...
materializado descrito na Seção~10.5: \textbf{Firestore permanece a fonte
...
matrícula, plaqueta) e a política de fallback por ID permanecem os da Seção~10.5.
\end{explicacao}

\subsubsection{Reagentes}
A busca de reagentes é feita sobre o catálogo JSON materializado (Seção~10.5),
